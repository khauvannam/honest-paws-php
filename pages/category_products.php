...
$pdo = conn();
$products = GetProductByCategoryId($pdo, $_GET['id']);
?>
...
<div class="mb-20">
    ...
    <div class="w-full flex justify-center">
        <div class="flex w-full max-w-[1440px] justify-between pt-12 gap-x-5">
            <?php foreach ($products
                           as $product): ?>
                <div class="flex-1 max-h-[350px]">
                    ...
                    <button class="h-[54px] w-full max-w-[355px] rounded-full flex justify-center items-center bg-[#00205c] hover:border-[#00205c] hover:border-2 hover:bg-[#FADC6F] group transition-all duration-200 mt-4">
